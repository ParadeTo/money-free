...
输入 JSON: {"symbol": "0700.HK", "start_date": "2016-01-01", "end_date": "2026-01-01"}
...
def fetch_yahoo_klines(symbol: str, start_date: str, end_date: str) -> List[Dict[str, Any]]:
    """
    使用Yahoo Finance获取K线数据
    ...
    try:
        ...
        raise Exception(f"Failed to fetch Yahoo Finance K-lines for {symbol}: {str(e)}")
...
def process_request(input_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        klines = fetch_yahoo_klines(symbol, start_date, end_date)
