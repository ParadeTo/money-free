        ...
        >
          <Space size="large" style={{ flex: 1 }}>
            <div {...listeners} style={{ cursor: 'grab', padding: '4px' }}>
              <DragOutlined style={{ fontSize: '16px', color: 'rgba(44, 62, 80, 0.35)' }} />
            </div>

            <div style={{ minWidth: '80px' }}>
              <Text style={{ fontSize: '16px', fontWeight: 600, color: 'rgba(44, 62, 80, 0.85)' }}>
                {favorite.stockCode}
              </Text>
            </div>
            ...
            <div style={{ minWidth: '100px', textAlign: 'right' }}>
              {latestPrice !== null && latestPrice !== undefined ? (
                <Text style={{ fontSize: '18px', fontWeight: 600, color: 'rgba(44, 62, 80, 0.85)' }}>
                  {latestPrice.toFixed(2)}
                </Text>
              ) : (
                <Text style={{ fontSize: '14px', color: 'rgba(44, 62, 80, 0.35)' }}>--</Text>
              )}
            </div>
              ...
              {priceChangePercent !== null && priceChangePercent !== undefined && priceChangePercent !== 0 ? (
                <Text
                  style={{
                    fontSize: '14px',
                    fontWeight: 600,
                    color: isPositive ? '#ff4d4f' : isNegative ? '#52c41a' : 'rgba(44, 62, 80, 0.65)',
                  }}
                >
