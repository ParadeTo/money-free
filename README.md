...
- ✅ K 线数据管理
- ✅ 股票筛选和收藏
- ✅ **VCP K线图叠加层** - 直观显示 VCP 收缩和回调区域
  - 收缩线：深青蓝色虚线连接 swing high 和 swing low
  - 回调线：橙色虚线，活跃回调使用更亮的橙色（#fb923c）
  - 自动标签：显示收缩/回调编号和深度百分比
  - 端点标记：小圆点标记关键价格点
  - 一键 Toggle：通过工具栏快速显示/隐藏 VCP 叠加层
  - 性能优化：可见范围过滤，仅渲染当前视图内的数据
